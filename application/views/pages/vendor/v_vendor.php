			...
			?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td class="text-center"><div align="center"><a class="btn-action" href="#modaledit<?php echo $data->venCode?>" data-toggle="modal" title="Edit"><i class="icon-note icons"></i>
                                                      ...
                                                      <a href="<?php echo base_url();?>vendor/delete_vendor/<?php echo $data->venCode?>" onclick="return confirm('Yakin Hapus  Akun ?');" title="Delete">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="smart-form">
                <form method="post" action="<?php echo site_url('vendor/update_vendor')?>">
                    <div class="modal-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label"> Initial </label>
                        <div class="col-sm-9"><span class="controls">
                          <input name="initial" type="text" class="form-control" required="required" id="initial" value="<?php echo $row->venInitial ;?>" maxlength="10" />
                        </span>
...
<div class="form-group">
 ...
 <div class="form-group">
              <label class="col-sm-3 control-label">Phone</label>
                        <div class="col-sm-9"><span class="controls">
                          <input name="phone" type="text" class="form-control" required="required" id="phone" value="<?php echo $row->Phone ;?>" maxlength="13" onkeypress="return isNumberKey(event)"/>
              </span></div>
                        <div class="clearfix"></div>
                      </div>
<div class="form-group">
 ...
 <div class="form-group">
                        ...
                        <div class="col-sm-9"><span class="controls">
                          <input name="postcode" type="text" class="form-control"  id="postcode" value="<?php echo $row->PostalCode ;?>" onkeypress="return isNumberKey(event)"/>
    </span></div>
                        <div class="clearfix"></div>
                      </div>
 <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="smart-form scroll">
                <form method="post" action="<?php echo site_url('vendor/save_vendor')?>">
                    <div class="modal-body">
<div class="form-group">
                      <label class="col-sm-3 control-label"> Initial </label>
                      <div class="col-sm-9"><span class="controls">
...
<div class="form-group">
              <label class="col-sm-3 control-label">Phone</label>
              <div class="col-sm-9"><span class="controls">
              <input name="phone" type="text" class="form-control" required="required" id="phone" maxlength="13" onkeypress="return isNumberKey(event)"/>
              </span></div>
              <div class="clearfix"></div>
 </div>
...
$("#txtsearch").keyup(function(){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo base_url('vendor/search_vendor_ajax'); ?>",
