...
$total+=$amount;
  ...
  <tr>
    ...
    <td style="text-align:left"><?php echo $items->sender.' - '.$items->receiver  ;?></td>
  ...
  <?php $no++; } ?>
  <tr>
    <td height="18" colspan="8"><div align="center"><label style="margin-right:20px; margin-top:9px; font-weight:bold">TOTAL &nbsp;</label></div></td>
