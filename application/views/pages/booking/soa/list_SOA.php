...
function edit_person2(id)
    {
      ...
      $.ajax({
        ...
        {
            $('[name="SoaDesc"]').val(data.SoaDesc);
			 $('[name="SoaNo"]').val(data.SoaNo	);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form">
        <form action="#" id="form2" class="form-horizontal">
          <input name="SoaNo" type="hidden" id="SoaNo" value=""/> 
          <div class="form-body">
            <div class="form-group">
              <label class="control-label col-md-3"> Name</label>
              <div class="col-md-9">
                <input name="SoaDesc" type="text" class="form-control nama" id="SoaDesc" placeholder="Name" value="" />
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3">Address</label>
              <div class="col-md-9">
                <textarea name="Customer" placeholder="decription"class="form-control" id="Customer"></textarea>
              </div>
            </div>
