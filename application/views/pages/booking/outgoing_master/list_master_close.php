 ...
 $(document).ready(function() {    
          ...
          tableclose = $('#tableclose').DataTable({ 
            "processing": true, //Feature control the processing indicator.
            "serverSide": true, //Feature control DataTables' server-side processing mode
            // Load data for the table's content from an Ajax source
            "ajax": {
                "url": "<?php echo site_url('Outgoing_master/ajax_list2')?>",
                "type": "POST"
            },
            "columns": [
            { "data": "no" },
...
$('#tableclose tbody').on('dblclick', 'tr', function () {
            var tr = $(this).closest('tr');
            var row = tableclose.row(tr);
...
function edit_final(id)
    ...
    {
      tableclose.ajax.reload(null,false); //reload datatable ajax 
    }
...
function delete_person5(id)
    ...
    <br />
    ad<br />
    <table id="tableclose" class="table table-striped table-bordered" cellspacing="0" width="100%">
      <thead>
        <tr>
          <th>no</th>  
          <th>House</th>
