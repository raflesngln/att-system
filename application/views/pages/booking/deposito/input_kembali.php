...
<form method="post" action="javascript:void(0);" id="inputform2" name="inputform2">
...
<div class="info-box">
     ...
     <div class="col-sm-9 col-xs-8"><i class="fa fa-plus"></i> Withdraw Deposito</div>
</div>
</div>
...
$("#inputform2").submit(function(e) {
	...
	if(conf==true){
       $.ajax({
                type: "POST",
				dataType: "JSON",
                url : "<?php echo base_url('payment/save_withdraw'); ?>",
