 ...
 $(document).ready(function() {    
          ...
          table_list = $('#table_list').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('payment/list_trans_deposito')?>",
                "type": "POST"
            },
            "columns": [
...
<div class="info-box">
     ...
     <div class="col-sm-9 col-xs-8">History Deposito </div>
</div>
</div>
</div>
...
<div class="clearfix"></div>
    ...
    <table id="table_list" class="table table-striped table-" cellspacing="0" width="100%">
      <thead>
        <tr>
          <th width="87">No</th>  
          <th width="158">Date</th>
          <th width="340">Cust Name</th>
          <th width="500">Remarks</th>
          <th width="176"> Amount</th>
          <th width="50" style="width:50px;">Action</th>
        </tr>
      </thead>
      <tbody>
      </tbody>
