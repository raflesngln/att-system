...
<div class="clearfx">&nbsp;</div>         
          ...
          <label class="col-sm-4"> House/Connote</label> 
          <div class="col-sm-7">
...
<div class="col-md-12">
                                              ...
                                              <div class="col-sm-7">
                                                <textarea name="attention" class="form-control" id="attention"></textarea>
                    </div>
                                             </div>
  ...
  <!-- RIGHT INPUT  -->
                                            <div class="col-md-6">
                                              ...
                                              <div class="col-sm-8">
                                              <input type="text" name="cwt" id="cwt" class="form-control" onkeypress="return isNumberKey(event)" required readonly><input type="hidden" name="ori_cwt" id="ori_cwt" value="0">
                                              </div>
                                                </div>
                                              <div class="col-md-12">
