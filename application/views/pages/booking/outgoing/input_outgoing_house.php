...
<label class="label label-inverse">Description</label>
    ...
    <div class="span7"><input name="house" type="text" class="form-control"  id="name" placeholder="generated by system" readonly /></div>
    </div>
    <div class="form-group">
...
<div class="col-sm-6">
        ...
        <div class="span7"><select data-placeholder="Choose Commodity..." class="chosen-select form-control" tabindex="2" required="required" name="commodity">
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-9"><span class="controls">
      <select name="city" id="city" required="required" class="form-control select2" style="width:95%">
