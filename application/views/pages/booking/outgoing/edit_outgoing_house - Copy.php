 ...
 <table class="table table-striped table-bordered table-hover" id="tblitems" style="width:95%">
                                              ...
                                              <tbody>
                                                ...
                                                <tr align="right">
                                                  ...
                                                  <td colspan="3">&nbsp;</td>
           <td width="20%"><label id="label_volume"><?php echo $volume; ?></label>                                                    <input name="t_volume" type="hidden" id="t_volume" value="<?php echo $volume; ?>" /></td>
       <td width="15%"><label id="label_weight"> <?php echo $gross; ?></label>                                           <input name="t_weight" type="hidden" id="t_weight" value="<?php echo $gross; ?>" />
                                                  </td>  
                                                  <td width="14%">&nbsp;</td>
                                                </tr>
...
<h2><span class="label label-large label-pink arrowed-in-right"><strong>COST / CHARGES</strong></span></h2>
 ...
 <th><input type="text" name="unit[]" id="pricefreight" onChange="return count_freight3(this);" required class="form-control" style=" text-align:right" value="<?php echo $fr->Price; ?>"></th>
      ...
      <input type="text" name="desc[]" id="descfreight" style="width:100%" class="form-control" value="<?php echo $fr->ChargeDetail; ?>">                                            
                                                  ...
                                                  <th><input type="text" name="totalcharges[]" id="totfreight" style="width:98%;text-align:right" value="<?php echo $fr->Total; ?>" required readonly class="form-control">
 ...
 ?>
                                                <tr>
                                                  ...
                                                  <th><input type="text" name="pricefreight" id="pricefreight2" style="width:98%; text-align:right" onChange="return count_freight2(this)" required class="form-control"  value="<?php echo $c_smu->Price; ?>"></th>
                                                  <th><input type="text" name="qtyfreight" id="qtyfreight2" style="width:98%;text-align:right" class="form-control" value="<?php echo $c_smu->Qty; ?>"></th>
                                                  <th><input type="text" name="descfreight" id="descfreight2" style="width:100%" class="form-control" value="<?php echo $c_smu->ChargeDetail; ?>"></th>
                                                  <th><input type="text" name="totfreight" id="totfreight2" style="width:98%;text-align:right" readonly required class="form-control" value="<?php echo $c_smu->Total; ?>"></th>
                                                  <th class="text-center">&nbsp;</th>
                                                </tr>
 <?php } ?>
   <?php 
 ...
 ?>
                                                <tr>
                                                  ...
                                                  <td width="158"><?php echo $opsi->Price; ?></td>
                                                  <td width="158"><?php echo $opsi->Qty; ?></td>
                                                  <td width="114"><?php echo $opsi->ChargeDetail; ?></td>
                                                  <td width="222"><div align="right"><?php echo $opsi->Total; ?></td>
                                                  <td class="text-center"><button value="<?php echo $opsi->Total; ?>" id="del_charge" class="del_charge btn btn-mini btn-danger" onClick="hapus3(this)" type="button">x</button></td>
                                                </tr>
    <?php } ?>
                                                </thead>
   ...
   ?>
                                                  <input name="total_charge" type="text" id="total_charge" value="<?php echo $grand;?>" />
...
<div class="col-sm-2"><p class="text-left"><input type="text" name="t_total" id="t_total" class="form-control txtrp" readonly value="dsdd">
...
if (txtunit == '' || txtqty == '' || charge == ''){
	...
	+'<td align="center">' + '<button class="btndel btn-danger btn-mini" value="' + kali +'" onclick="hapus3(this)" type="button"><i class="fa fa-times"></i></button>'
	+ ' <button class="btneditcharge btn-primary btn-mini" value="' + idcharge +'/'+ nmcharge +'/'+ txtunit +'/'+ txtqty +'/'+ desc +'/'+ kali +'" onclick="editcharge(this)" type="button"><i class="fa fa-edit"></i></button></td>'
...
function editcharge(myid){
	...
	text='<tr class="gradeX">'
	 ...
	 +'<td><input type="hidden" name="idcharge[]" id="idcharge[]" value="'+ pecah +'">'+ nama +'</td>'
	 +'<td><input type="hidden" name="idcharge[]" id="idcharge[]" value="'+ pecah +'">'+ nama +'</td>'
	 +'<td><button class="btndel btn-danger btn-mini" value="' + nama +'" onclick="hapus3(this)" type="button"><i class="fa fa-times"></i></button>'
