...
<div class="info-box">
     ...
     <div class="col-sm-9 col-xs-8">Create Incoming </div>
</div>
</div>


<form method="post" action="<?php echo base_url();?>transaction/confirm_incoming_house" autocomplete="off" id="myform" onsubmit="return validasiform()" name="myform">
...
<label class="label label-inverse">Description</label>
    ...
    <div class="span4">Job No</div>
    <div class="span7"><input name="job" type="text" class="form-control"  id="name" placeholder="generated by system" readonly/></div>
    </div>
    <div class="form-group">
    <div class="span4">House No</div>
    <div class="span7"><input name="house" type="text" class="form-control"  id="name" placeholder="house no" required="required" /></div>
    </div>
    <div class="form-group">
    <div class="span4">Payment Type<sup class="must"> *</sup></div>
    <div class="span7"><select name="paymentype" class="form-control" required="required" id="paymentype">
    ...
    <div class="form-group">
    <div class="span4">Origin<sup class="must"> *</sup></div>
    <div class="span7"><select name="origin" id="origin" class="form-control select2" required="required" onChange="return getflight()">
    ...
    <div class="form-group">
    <div class="span4">Destination<sup class="must"> *</sup></div>
    <div class="span7"><select name="desti" id="desti" class="form-control select2" required="required" onChange="return getflight()">
    ...
    <div class="form-group">
    <div class="span4">Departure Date</div>
    <div class="span7"><input name="etd" type="text" class="form-control"  id="etd" required value="<?php echo date("Y-m-d") ;?>" onChange="return getflight()" readonly/></div>
    </div>
    <div class="form-group">
    <div class="span4">Service<sup class="must"> *</sup></div>
    <div class="span7"><select name="service" id="service" class="form-control" required="required">
...
<div class="form-group">
           <label class="span4">Air Line<sup class="must"> *</sup></label> 
          <div class="span7">
 ...
 <div class="form-group form-inline">
          <label class="span4">SMU No<sup class="must"> *</sup></label> 
          <div class="span2">
...
<div class="form-group" style="display:none" id="divalert">
 ...
 <div class="form-group">
<label class="span4">Flight Number<sup class="must"> *</sup></label>
<div class="span8">
		<div class="row">
...
<div class="form-group">
<label class="span4">ETD / ETA </label>
<div class="span7">
...
<div class="col-sm-6">
		<div class="form-group">
        <div class="span4">Commodity</div>
        <div class="span7"><select data-placeholder="Choose Commodity..." class="select2 form-control" tabindex="2" required="required" name="commodity">
        ...
        <div class="form-group">
        <div class="span4">Special  instruction</div>
        <div class="span7"><textarea name="special" class="form-control" id="special"></textarea></div></div>
        <div class="form-group">
        <div class="span4">Attention</div>
        <div class="span7"><textarea name="attention" class="form-control" id="attention"></textarea></div></div>
</div>
<div class="col-sm-6">
		<div class="form-group">
        <div class="span4">CWT</div>
        <div class="span7"><input type="text" name="cwt" id="cwt" class="form-control" onkeypress="return isNumberKey(event)" required readonly>
          <span class="col-sm-8">
          <input type="hidden" name="ori_cwt" id="ori_cwt" value="0">
          </span></div></div>
        <div class="form-group">
        <div class="span4">Declare Value</div>
        <div class="span7"><textarea name="description" id="declare" class="form-control"></textarea></div></div>
        <div class="form-group">
        <div class="span4">Desc of Shipment</div>
        <div class="span7"><textarea name="description" id="declare" class="form-control"></textarea></div></div>
</div>
</div><!-- end of bottom input -->
...
<h2><span class="label label-large label-inverse "> COST / CHARGES </span></h2>
 ...
 <input type="hidden" name="idcharge[]" id="idcharge[]" value="6">
   </span></th>
...
<label id="label_totfreight" style="float:right;color:#1963aa;font-style:italic">0</label>
                                                ...
                                                <tr>
                                                  <th width="77"><span class="col-sm-4">Administrasi
                                                    <input type="hidden" name="idcharge[]" id="idcharge[]" value="7">
                                                  </span></th>
