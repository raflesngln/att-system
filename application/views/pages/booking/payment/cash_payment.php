...
<div class="info-box">
     ...
     <div class="col-sm-9 col-xs-8">Cash Payment</div>
</div>
</div>
      

<br style="clear:both">
<form method="post" action="<?php echo base_url();?>payment/process_cash_payment" id="myform" onsubmit="return konfirmasi()" class="myform"  name="myform" target="new">
<div class="container">
  <div class="row">
               <!--LEFT INPUT-->
  <div class="col-sm-6">      
...
<div class="form-group">             
          <label class="col-sm-3"> Users<sup class="must"> *</sup></label>
          <div class="col-sm-7">
           <select name="iduser" id="iduser" class="form-control select2" required="required" onchange="return filter_payment()">
          <option value="">Choose Customer</option>
          <?php foreach ($user as $cust) {
          ?>
          <option value="<?php echo $cust->id_user;?>"><?php echo $cust->UserName;?></option>
          <?php } ?>
          </select>
          </div>
</div>
 <div class="form-group">             
          <label class="col-sm-3"> Methode<sup class="must"> *</sup></label>
          <div class="col-sm-7">
           <select name="methode" id="methode" class="form-control select2" required="required" onchange="return filter_payment()">
	...
	swal({
		...
		html:true
          ...
          $.ajax({
 			...
 			data: "iduser="+iduser+"&etd1="+etd1+"&etd2="+etd2+"&methode="+methode+"&payTipe="+payTipe,
