...
<script src="<?php echo base_url();?>asset/js/jquery.PrintArea.js"></script>
  ...
  <form method="post" action="<?php echo base_url();?>transaction/preview_outgoing_house">
    ...
    <div class="col-md-5">
  <div class="col-sm-12">
<label class="col-sm-5 label label-default" style="padding-top:8px"><p align="left"><i class="fa fa-send"></i>&nbsp; Sender</p></label> 
</div>
...
<div class="form-group"><strong><span class="col-sm-4">Destination</span></strong>
 ...
 <div class="form-group"><strong><span class="col-sm-4">Shipper</span></strong>
   <div class="col-sm-7">: <?php echo $_POST['name1'];?>
     ...
     drud
     <input name="address1" type="hidden" id="name10" value="<?php echo $_POST['address1'];?>" />
   </div>
 </div><div class="clearfix"></div> 
    </div>
    ...
    <div class="col-md-6">
<div class="col-sm-12">
<label class="col-sm-5 label label-default" style="padding-top:8px"><p align="left"><i class="fa fa-sign-in"></i>&nbsp; Receivement</p></label> 
...
<div class="form-group"> 
    ...
    <div class="form-group"> 
        ...
        <div class="col-sm-7">: <?php echo $_POST['name2'];?>
          ...
          <input name="name3" type="hidden" id="name11" value="<?php echo $_POST['phone1'];?>" />
          <input name="name4" type="hidden" id="name12" value="<?php echo $_POST['address1'];?>" />
        </div>
</div><div class="clearfix"></div>
...
<div class="col-sm-11">         
 ...
 <div class="col-sm-10">
    <h2><span class="label label-large label-pink arrowed-in-right"><strong>LIST ITEMS</strong></span></h2>
...
<a href="<?php echo base_url();?>transaction/domesctic_outgoing_house"><button class="btn btn-primary" type="button"><i class="icon icon-ok bigger130"></i>Finish !</button></a>
</div>
